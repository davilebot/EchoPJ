...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_company_search_uses_grouped_filters_and_custom_selection_ui(self):
        ...
        self.assertIn('data-filter-section-toggle', self.html)
        self.assertIn('id="search-partners-min"', self.html)
        self.assertIn('id="search-partners-max"', self.html)
        self.assertIn('id="search-included-list-picker"', self.html)
        self.assertIn('id="search-excluded-list-picker"', self.html)
        self.assertIn('id="search-saved-status"', self.html)
